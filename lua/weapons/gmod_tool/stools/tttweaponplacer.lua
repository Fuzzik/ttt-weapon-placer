...
TOOL.Name = "Fuzzik's TTT Weapon Placer"
TOOL.Command = nil
TOOL.ConfigName = ""
...
local weps = {
   ...
   weapon_ttt_famas = {name="FAMAS", snd="item_ammo_pistol_ttt"},
   weapon_ttt_g3sg1 = {name="G3SG1", snd="item_ammo_357_ttt"},
   weapon_ttt_galil = {name="Galil", snd="item_ammo_smg1_ttt"},
   weapon_ttt_mp5 = {name="MP5 Navy", snd="item_ammo_pistol_ttt"},
...
local mdls = {
   ...
   weapon_ttt_g3sg1 = "models/weapons/w_snip_g3sg1.mdl",
...
local enttypes = {
   ...
   weapon_ttt_pistol = WEAPON_PISTOL,
